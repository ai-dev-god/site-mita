...
# ── lamitabiciclista.ro/expo-2026 (LAM-776 ticket page) ──
# Production landing for "Colecționarii. Numai Pictura." (16 mai – 16 iulie 2026).
# Served from a subfolder of the apex docroot, no separate vhost needed.
EXPO_DOCROOT="/home/mita/public_html/expo-2026"
if [ -d "$REPO_DIR/marketing/expo-2026" ]; then
  log "Syncing marketing/expo-2026 -> $EXPO_DOCROOT..."
  sudo mkdir -p "$EXPO_DOCROOT"
  sudo rsync -a --delete \
    "$REPO_DIR/marketing/expo-2026/" "$EXPO_DOCROOT/"
